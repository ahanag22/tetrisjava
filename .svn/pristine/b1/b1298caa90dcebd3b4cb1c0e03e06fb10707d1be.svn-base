...
public final class Board extends Observable {
    ...
    /**
     * I have written this instance field,it helps me to get the number of cleared lines.
    ...
    private void clearLines() {
         ...
         *setting the value of the myLinesCleared as 0. 
         */
        myLinesCleared = 0;
        ...
        for (int i = myFrozenBlocks.size() - 1; i >= 0; i--) {
            ...
            if (clear) {
                ...
                /*
                 * I have made a change.
                 * when line gets cleared,myLinesCleared is increasing.
                 */
                myLinesCleared++;
                setChanged();
                notifyObservers();
     ...
     * This method returns the value how many lines get cleared.
     * A getter method.
     * @return returns number of rows cleared from the board.
     */
    public int getLinesRemoved() {
        final int toRet = this.myLinesCleared;
        this.myLinesCleared = 0;
        return toRet;
    }
